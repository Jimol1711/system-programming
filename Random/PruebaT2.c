...
void eliminar(char *str, char *pat) {
    ...
    while (*str) {
        ...
        // Check if the pattern matches from the current position of str
        ...
        if (coincidencia) {
            // If there's a match, advance the str pointer
            str += strlen(pat);
            contador++;
        } else {
            // Copy the character to the destination and move both pointers
            *dest = *str;
            dest++;
            str++;
        }
...
int main() {
    // Eliminar
    char str1[] = "11101100101010010100010";
    char pat1[] = "10";
    ...
    printf("\n");
    // Eliminados
    char str2[] = "111010010100011010010";
    char pat2[] = "10";
